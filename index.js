...
if(cinm<=9){
  ...
  const msg={
      to: email,
      from: 'harsh1081.cse19@chitkara.edu.in',
      subject:"Entering the Building",
      text:`Hi! Welcome to the office, You entered at ${h}:${m}  Have a good day`
  };
...
const msg={
      to: email,
      from: 'harsh1081.cse19@chitkara.edu.in',
      subject:"Checking out of Building",
      text:`Hi! you checked out at ${h}:${m}, Thanks for the Visit`
  };
